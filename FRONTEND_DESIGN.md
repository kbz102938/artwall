...
│  ┌────────────────────────────────────────────────────────────────────────┐  │
│  │                                                                        │  │
│  │    [Background: Beautiful living room with statement painting]         │  │
│  │                                                                        │  │
│  │                     为您的家，找到那幅画                                 │  │
│  │                                                                        │  │
│  │              AI 驱动的艺术推荐，让每一面墙都成为风景                       │  │
│  │                                                                        │  │
│  │                    [  开始探索  ]                                       │  │
│  │                                                                        │  │
│  │                         ↓ 了解更多                                      │  │
...
│     │      📷      │      │      🎨      │      │      ✨      │            │
│     │              │      │              │      │              │            │
│     │   上传房间照片  │      │  选择喜欢的风格  │      │  获得专属推荐  │            │
│     │              │      │              │      │              │            │
│     │ 让我们了解您的  │      │ 从8种家居风格中   │      │ AI为您匹配最   │            │
│     │ 空间氛围       │      │ 选择1-3种偏好    │      │ 适合的艺术品   │            │
│     └──────────────┘      └──────────────┘      └──────────────┘            │
│                                                                              │
├──────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
...
│  │  ┌───────────────────┐  ┌───────────────────┐  ┌───────────────────┐   │ │
│  │  │                   │  │                   │  │                   │   │ │
│  │  │  [Living room     │  │  [Bedroom with    │  │  [Study with      │   │ │
│  │  │   with modern     │  │   Japanese art]   │  │   classic art]    │   │ │
│  │  │   abstract art]   │  │                   │  │                   │   │ │
│  │  │                   │  │                   │  │                   │   │ │
│  │  │   现代简约 × 抽象   │  │   日式侘寂 × 水墨  │  │   美式古典 × 油画  │   │ │
│  │  └───────────────────┘  └───────────────────┘  └───────────────────┘   │ │
│  │                                                                         │ │
│  └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                              │
...
│  ┌────────────────────────────────────────────────────────────────────────┐  │
│  │                                                                        │  │
│  │    [Gradient background with subtle art pattern]                       │  │
│  │                                                                        │  │
│  │                      准备好发现您的艺术品了吗？                           │  │
│  │                                                                        │  │
│  │                       [  立即开始，免费使用  ]                           │  │
...
### Behavior
1. "开始探索" / "立即开始" → Check if returning user
   - New user → `/onboarding`
   - Returning user → `/feed`
2. "探索" nav link → `/feed` (skip onboarding for browsing)
3. "收藏" nav link → `/saved`
